                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        ?>
                            ...
                            <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item @@dashboardMessages" href="dashboard-my-ads.html">My Cars</a></li>
                                    <li><a class="dropdown-item @@dashboardFavouriteAds" href="dashboard-favourite-ads.html"> Favourite Car</a></li>
                                    <li><a class="dropdown-item @@dashboardFavouriteAds" href="Logout.php"> Logout</a></li>
                                </ul>
                            </li>

...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 15, 2024 at 06:17 AM
...
INSERT INTO `customer` (`uid`, `name`, `email`, `ph_no`, `address`) VALUES
...
('CUST011', 'Deepak Singh Kushwaha', 'ds2390521@gmail.com', 2147483647, 'Lathiya village Bari bazar Varanasi uttarpradesh'),
('CUST012', 'Deepak Singh Kushwaha', 'ds2390521@gmail.com', 2147483647, 'Lathiya village Bari bazar Varanasi uttarpradesh');
...
--
ALTER TABLE `booking`
  ADD CONSTRAINT `booking_sc_id` FOREIGN KEY (`sc_id`) REFERENCES `service_center` (`sc_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `booking_uid` FOREIGN KEY (`uid`) REFERENCES `customer` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE;

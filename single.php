			...
			<div class="row">
				...
				<div class="col-lg-8">
					<div class="product-details">
						<h1 class="product-title">CAR DISCRIPTION</h1>
						<div class="product-meta">
							<ul class="list-inline">
								<li class="list-inline-item"><i class="fa fa-user-o"></i> By <a href="user-profile.html">User</a></li>
								<li class="list-inline-item"><i class="fa fa-folder-open-o"></i> Category<a href="category.html">Car</a></li>
								<li class="list-inline-item"><i class="fa fa-location-arrow"></i> Location<a href="category.html">Varanasi, Uttarpradesh</a></li>
							</ul>
						</div>
							...
							<ul class="nav nav-pills  justify-content-center" id="pills-tab" role="tablist">
								<li class="nav-item">
									<a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home"
									 aria-selected="true">Cars Details</a>
								</li>
								<li class="nav-item">
				...
				<div class="col-lg-4">
					<div class="sidebar">
						...
						<div class="widget user text-center">
							...
							<h4><a href="user-profile.html">XYZ</a></h4>
							<p class="member-time">Member Since Jun 27, 2017</p>
							<!-- <a href="single.html">See all ads</a> -->
							<ul class="list-inline mt-20">
								<li class="list-inline-item"><a href="contact.php" class="btn btn-contact d-inline-block  btn-primary px-lg-5 my-1 px-md-3">Contact</a></li>
								<li class="list-inline-item"><a href="single.php" class="btn btn-offer d-inline-block btn-primary ml-n1 my-1 px-lg-4 px-md-3">BUY</a></li>
							</ul>
						</div>
						<!-- Map Widget -->
						...
						<div class="widget coupon text-center">
							...
							<!-- Submii button -->
							<a href="single.html" class="btn btn-transparent-white">Submit Post</a>
						</div>
